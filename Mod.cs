...
namespace KitchenJacuzziTable
{
    public class Mod : BaseMod, IModSystem
    {
        ...
        public const string MOD_GUID = "Nghia.PlateUp.JacuzziTable";
        public const string MOD_NAME = "Jacuzzi Table";
        ...
        private void AddGameData()
        {
            ...
            AddGameDataObject<JacuzziTable>();
        ...
        protected override void OnPostActivate(KitchenMods.Mod mod)
        {
            ...
            // TODO: Also, make sure to set EnableAssetBundleDeploy to 'true' in your JacuzziTable.csproj
